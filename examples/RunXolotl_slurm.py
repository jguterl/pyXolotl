...
ncore = 32
X.setup_slurm(command_slurm = ['module load /home/guterlj/xolotl.mod','mpirun -n {} xolotl {}'.format(ncore,X.param_filename)])


X.sbatch(p='preemptable',n=ncore,log_dir=X.get_directory(), D=X.get_directory(),script_dir=X.get_directory(),script_name='job_xolotl.batch')
#X.monitor()
